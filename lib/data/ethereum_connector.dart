...
class WalletConnectEthereumCredentials extends CustomTransactionSender {
  ...
  Future<EthereumAddress> extractAddress() async {
    final accounts = await provider.connector.session.accounts;
    return EthereumAddress.fromHex(accounts[0]);
  }
...
class EthereumConnector implements WalletConnector {
  ...
  Future<SessionStatus?> connect(BuildContext context) async {
    return await _connector.connect(context, chainId: 80001);
  }
  ...
  final _ethereum = Web3Client(
      'https://polygon-mumbai.g.alchemy.com/v2/Cvw6m9v0HmD_72Hydep2dGMHOT8qTy3K',
      Client());
}
